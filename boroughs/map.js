...
maps["healthOutcomesMap"] = L.map("healthOutcomesMap", {
  ...
  zoomSnap: ZOOM_INCREMENT,
  zoomDelta: ZOOM_INCREMENT,
})//.setView([moveView.lat,moveView.lng], zoomView);
...
maps["screeningRatesMap"] = L.map("screeningRatesMap", {
  ...
  zoomSnap: ZOOM_INCREMENT,
  zoomDelta: ZOOM_INCREMENT,
})//.setView([moveView.lat,moveView.lng], moveZoom);
...
//     maps["healthOutcomesMap"].on('moveend',function(e) {
//     moveView = e.target.getCenter();
//     zoomView = e.target.getZoom();
//     maps["demographicLanguageMap"].setView(([moveView.lat, moveView.lng]), zoomView);
//     maps["healthRiskBehaviorsMap"].setView(([moveView.lat, moveView.lng]), zoomView);
...
//   .addEventListener("click", () => {
//     maps["screeningRatesMap"].on('moveend',function(e) {
//     moveView = e.target.getCenter();
//     zoomView = e.target.getZoom();
//     maps["healthRiskBehaviorsMap"].setView(([moveView.lat, moveView.lng]), zoomView);
//     maps["healthOutcomesMap"].setView(([moveView.lat, moveView.lng]), zoomView);
...
//   .addEventListener("click", () => {
//     maps["healthStatusMap"].on('moveend',function(e) {
//     moveView = e.target.getCenter();
//     zoomView = e.target.getZoom();
//     maps["healthRiskBehaviorsMap"].setView(([moveView.lat, moveView.lng]), zoomView);
//     maps["healthOutcomesMap"].setView(([moveView.lat, moveView.lng]), zoomView);
